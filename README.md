...
The webpages are generated using the [Nikola](https://getnikola.com/) static site generator.
...
rebuilt and committed via a CI deploy step. You can also run `make auto` to
...
to the [`gh-pages`](https://github.com/pypy/pypy.org/tree/gh-pages) branch,
which is a copy of the `public/` directory. The contents of the branch are then
served by GitHub pages at https://pypy.org.
