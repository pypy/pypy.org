...
.. canonical: https://bernsteinbear.com/blog/toy-load-store/
-->

This is a <a href="https://bernsteinbear.com/blog/toy-load-store/"
rel=canonical>cross-post</a> from Max Bernstein from his blog where he writes
...
invalidate all of our compile-time offset K knowledge&mdash;even if it's for
...
[^tbaa]: We could do better. If we had type information, we could also use that
    ...
    Map, for example. This requires your compiler to have strict aliasing&mdash;if
...
This small optimization pass may seem silly or fiddly&mdash;when would we ever see
something like this in a real IR?&mdash;but it's pretty useful. Here's the Ruby
